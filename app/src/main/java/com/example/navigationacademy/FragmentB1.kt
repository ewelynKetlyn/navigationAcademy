 ...
 * Use the [FragmentB1.newInstance] factory method to
...
class FragmentB1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.btnFragmentB1).setOnClickListener {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentB1.
         */
